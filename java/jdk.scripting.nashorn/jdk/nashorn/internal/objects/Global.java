...
public final class Global extends Scope {
    ...
    public static Object __noSuchProperty__(final Object self, final Object name) {
        ...
        if ("context".equals(nameStr)) {
            ...
            // expose "engine" variable when there is no security manager
            if (System.getSecurityManager() == null) {
                return global.engine;
            } else {
                // SecurityManager is set. But, we still check class filter and _no_java mode.
                // Expose 'engine' only if no class filter set && _no_java is false.
                if (global.getClassFilter() == null && global.context.getEnv()._no_java == false) {
                    return global.engine;
                }
            }
        }
